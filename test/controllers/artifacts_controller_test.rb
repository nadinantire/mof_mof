...
class ArtifactsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create artifact" do
    assert_difference('Artifact.count') do
      post artifacts_url, params: { artifact: { amount: @artifact.amount, category: @artifact.category, description: @artifact.description, image: @artifact.image, name: @artifact.name } }
    end
  ...
  test "should update artifact" do
    patch artifact_url(@artifact), params: { artifact: { amount: @artifact.amount, category: @artifact.category, description: @artifact.description, image: @artifact.image, name: @artifact.name } }
